...
#   $OPENCODE_CONFIG_DIR/dgafka/.opencode/plugins/dgafka.js ← plugin file
#   $OPENCODE_CONFIG_DIR/plugins/dgafka.js   ← symlink OpenCode reads

SUPERPOWERS_DIR="$OPENCODE_CONFIG_DIR/dgafka"
SUPERPOWERS_SKILLS_DIR="$SUPERPOWERS_DIR/skills"
SUPERPOWERS_PLUGIN_FILE="$SUPERPOWERS_DIR/.opencode/plugins/dgafka.js"
...
cp "$REPO_ROOT/.opencode/plugins/dgafka.js" "$SUPERPOWERS_PLUGIN_FILE"

# Register plugin via symlink (what OpenCode actually reads)
mkdir -p "$OPENCODE_CONFIG_DIR/plugins"
ln -sf "$SUPERPOWERS_PLUGIN_FILE" "$OPENCODE_CONFIG_DIR/plugins/dgafka.js"
...
echo "Plugin registered at: $OPENCODE_CONFIG_DIR/plugins/dgafka.js"
